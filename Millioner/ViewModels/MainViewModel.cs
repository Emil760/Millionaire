...
namespace Millioner.ViewModels
{
    class MainViewModel
    {
        ...
        public MainViewModel(Window window)
        {
            ...
            UsersInfoCommand = new Command(UsersInfo);
            ExitCommand = new Command(Exit);
        }

        public ICommand LoginCommand { get; }
        public ICommand EditCommand { get; }
        public ICommand UsersInfoCommand { get; }
        ...
        public void UsersInfo(object param)
        {
            UsersInfoWindow window = new UsersInfoWindow();
            window.Closed += FormClosed;
            window.Show();
            this.window.Hide();
        }
